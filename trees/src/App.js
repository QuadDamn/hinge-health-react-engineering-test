        ...
        <Row>
          <Col>
            <img
              alt="app-logo"
              className="App-logo"
              src="https://www.hingehealth.com/s/hh-logo.png"
            />
          ...
          <Col sm={6}>
            <div className="App-instructions">
                ...
                <ol>
                  ...
                  <li>
                    <i>
                      ...
                      the same as the original? (Show work in a new commit.)
                    </i>
                  </li>
                  <li>
                    <i>
                ...
                <ol>
                  ...
                  <li>
                    <i>
                      ...
                      removed from the tree properly?
                    </i>
                  </li>
                </ol>
              </div>
              ...
              <div className="App-instructions">
                ...
                <a href="http://myjson.com/api">http://myjson.com/api</a>
                <ol>
                  <li>
